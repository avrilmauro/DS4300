...
def get_user_data(api, userid, tweet_form='text'):
    ...
    if tweet_form == 'text':
        ...
        pp.pprint(len(api.get_tweets(userid)), indent=4)
    print("Timeline:")
    pp.pprint(api.get_timeline(userid, store_ref='tweet_store'), indent=4)
